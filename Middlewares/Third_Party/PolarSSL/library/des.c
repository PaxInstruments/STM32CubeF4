                   ...
                   unsigned char output[8] )
{
  ...
  {  
    ...
    /* Init Crypto periph */
    HAL_CRYP_Init(&hcryp_tdes);
    
    /* Encrypt data */
    HAL_CRYP_TDESECB_Encrypt(&hcryp_tdes, (uint8_t *)input, 8, (uint8_t *)output, 10);
  }
  else /* 3DES decryption */
  {
    ...
    /* Decrypt data */
    HAL_CRYP_TDESECB_Decrypt(&hcryp_tdes, (uint8_t *)input, 8, (uint8_t *)output, 10);
  }
