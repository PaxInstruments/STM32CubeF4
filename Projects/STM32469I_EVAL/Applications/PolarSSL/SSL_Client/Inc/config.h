...
/* include STM32F4Cube HAL library */
 ...
 *
 * Enable the RSA prime-number generation code.#define POLARSSL_GENPRIME
 */
 ...
 * This enables support for RSAES-OAEP and RSASSA-PSS operations.#define POLARSSL_PKCS1_V21
 */
